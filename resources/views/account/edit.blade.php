...
<form class="form-horizontal" role="form" action="{{url('account/update/'.$res->account_id)}}" method="post">
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" id="account_tels" name="account_tels"
				   value="{{$res->account_tels}}">
                   <span id="span_tels"></span>
                   <b style="color:red">{{$errors->first('_tels')}}</b>
		</div>
	</div>
