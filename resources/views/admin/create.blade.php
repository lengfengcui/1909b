					...
					<div class="page-content">
							<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="用户名" name="admin_name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name="admin_pwd" id="form-field-2" placeholder="密码" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name="admin_tel" id="form-field-2" placeholder="手机号" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name="admin_email" id="form-field-2" placeholder="邮箱" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 级别 </label>

														<div class="col-sm-9">
															<input type="radio" name="admin_rank" value="产品经理">产品经理
															<input type="radio" name="admin_rank" value="业务员">业务员
														</div>
									</div>
